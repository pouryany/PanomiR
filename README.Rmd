...
For miRNA prioritization it is important to have a precalculated list of miRNA-pathway association for all possible pairs. While in the distributed package we will provide some tables. Here, I will demonstrate how to generate such tables using miRNA-target lists.
